...
<div class="content-wrapper">
    <section class="content ">
      ...
      <div class="box">
        ...
        <div class="box-body">
          <table class="table table-bordered table-striped" id="dataTableP" width="100%" cellspacing="0">
              ...
              @foreach($datosTablaProgramacion as $item)
                <tr class="item{{ $item->id_liderazgo_ssoma }}">
                  ...
                  <td style="font-size: 90%">
                    <form action="{{ route('programacion_destroy',$item->id_liderazgo_ssoma) }}" method="POST">
                      @csrf
                      @method('DELETE')
                      <button class="btn btn-danger btn-sm" style="background-color: #444242;border-color: #444242;font-size: 90%"><i class="fa far fa-trash"></i> Eliminar</button>
                    </form>
                  </td>
                </tr>
                @endforeach
                ...
                <tr class="item{{ $item->id_liderazgo_ssoma }}">
                  ...
                  <td style="font-size: 80%">
                    <form action="{{ route('programacion_destroy',$item->id_liderazgo_ssoma) }}" method="POST">
                      @csrf
                      @method('DELETE')
                      <button class="btn btn-danger btn-sm" style="background-color: #444242;border-color: #444242;font-size: 80%"><i class="fa far fa-trash"></i> Eliminar</button>
                    </form>
                  </td>
                </tr>
                @endforeach
                ...
                <tr class="item{{ $item->id_liderazgo_ssoma }}">
                  ...
                  <td style="font-size: 80%">
                    <form action="{{ route('programacion_destroy',$item->id_liderazgo_ssoma) }}" method="POST">
                      @csrf
                      @method('DELETE')
                      <button class="btn btn-danger btn-sm" style="background-color: #444242;border-color: #444242;font-size: 80%"><i class="fa far fa-trash"></i></button>
                    </form>
                  </td>
                </tr>
                @endforeach
                ...
                <tr class="item{{ $item->id_liderazgo_ssoma }}">
                  ...
                  <td style="font-size: 75%">
                    <form action="{{ route('programacion_destroy',$item->id_liderazgo_ssoma) }}" method="POST">
                      @csrf
                      @method('DELETE')
                      <button class="btn btn-danger btn-sm" style="background-color: #444242;border-color: #444242;font-size: 75%"><i class="far fa-trash"></i></button>
                    </form>
                  </td>
                </tr>
                @endforeach
        ...
        <div class="container">
          <div class="row">
            <div class="col-md-3 ">
              <a style="background-color: #DD4B39;border-color: #DD4B39;" href="{{ route('programacion_anual_registro') }}" class="btn btn-primary"><i class="far fa-calendar-alt"></i> Registrar Programa</a>
      ...
      <div class="form-grou row">
        <div class="col col-lg-12 col-md-12">
          <div class="box">
            ...
            <div class="box-body">
              <div>
                <p>Usted no esta asignado a ningún Proyecto por el momento, comuniquese con la Oficina Corporativa SSOMA para mayor Información.</p>
              </div>
            </div>    
          </div>
        </div>
